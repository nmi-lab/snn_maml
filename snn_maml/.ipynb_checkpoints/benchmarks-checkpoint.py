...
def get_benchmark_by_name(name,
    ...
    if name == 'omniglot':
        ...
        data_dir = '../snn_maml/data/nmnist/n_mnist.hdf5' #folder+'/data/nmnist/n_mnist.hdf5'
        ...
        if params_file is None:
            params_file = 'parameters/lava_params_dnmnist_MLP.yml'#folder+'/parameters/lava_params_dnmnist.yml'
